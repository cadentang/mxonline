# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-09-11 15:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.CourseOrg', verbose_name='机构名称')),
            ],
            options={
                'verbose_name': '教师',
